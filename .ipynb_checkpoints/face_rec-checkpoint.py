...
hostname='redis-14393.c258.us-east-1-4.ec2.cloud.redislabs.com'
portnumber=14393
password='KgPXRV9IjlZbDOjcxsAi9d2Hyca4hREe'
...
class RegistrationForm:
    ...
    def save_data_in_redis_db(self,id,name,country):
        ...
        #redis hashes
        r.hset(name='kdu_student:register',key=key,value=x_mean_bytes)
        #
